...
#let book(title: "", subtitle: "", date: "", author: (), paper-size: "a4", width: none, height: none, margin: (x: 3cm, bottom: 2.5cm, top: 3cm), logo: none, cover: none, cover-background: auto, cover-height: auto, title-size: 2.2em, subtitle-size: 1.4em, author-size: 1.6em, image-index:none, body, main-color: blue, copyright: [], lang: "en", list-of-figure-title: none, list-of-table-title: none, supplement-chapter: "Chapter", supplement-part: "Part", font-size: 10pt, part-style: 0, part-font-size: auto, lowercase-references: false, padded-heading-number: true, outline-font-size: auto, outline-small-depth: 2, outline-small-width: 9.5cm, heading-style: 0, first-line-indent: true, outline-depth: 3) = {
  ...
  page(margin: 0cm, header: none)[
    ...
    #align(center + horizon, block(width: 100%, fill: cover-fill-color, height: cover-height, pad(x:2cm, y:1.2cm)[
      #text(size: title-size, weight: "black", title)
      #v(0.6cm, weak: true)
      #text(size: subtitle-size, subtitle)
      #v(0.6cm, weak: true)
      #text(size: author-size, weight: "bold", author)
    ]))
  ]
  if (copyright!=none){
    set text(size: 10pt)
